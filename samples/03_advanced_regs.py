...
if __name__ == '__main__':
    ...
    regset = RegisterSet(name='my_registers', base_address=0x00, port_size=32, registers=[

        # This register can both read and write; this allows us to do read-modify-write accesses
        Register(name='config1', description='Config Data 1', address=..., regtype=RegType.WriteRead, fields=[
        ...
        Register(name='config2', description='Config Data 2', comment="HW is strobed after change", address=..., regtype=RegType.Write, write_event=WriteEventType.StrobeAfterWriteOnCycleEnd, fields=[
